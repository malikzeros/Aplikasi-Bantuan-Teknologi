          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                SizedBox(
                  width: 30,
                  child:
                      Text(isocodetiket, style: TextStyle(color: Colors.green)),
                ),
                SizedBox(
                  width: 5,
                ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () async {
                    file_tiket = await ImagePicker.pickImage(
                        source: ImageSource.gallery);
                    setState(() {
                      _file_tiket = file_tiket;
                    });
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () async {
                    file_invoice = await ImagePicker.pickImage(
                        source: ImageSource.gallery);
                    setState(() {
                      _file_invoice = file_invoice;
                    });
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () async {
                    file_voucher = await ImagePicker.pickImage(
                        source: ImageSource.gallery);
                    setState(() {
                      _file_voucher = file_voucher;
                    });
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () async {
                    file_aml = await ImagePicker.pickImage(
                        source: ImageSource.gallery);
                    setState(() {
                      _file_aml = file_aml;
                    });
                  ...
                  onPressed: () async {
                    ...
                    if (file_invoice != null) {
                      ...
                      http.post(Bantek.url_uploads_invoice, body: {
                        ...
                        "id": id.toString(),
                        "id_bantek": id_bantek.toString(),
                        "invoice_amount": isocodeinvoice +
                            " " +
                            invoice_amount.text.toString(),
                      }).then((res) {
                        print(res.statusCode);
                        print(res.body);
                      }).catchError((err) {
